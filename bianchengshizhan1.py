...
class MyFrame1(wx.Frame):
    def __init__(self,parent,id):
        ...
        self.grid2.SetCellValue(0, 1, '鼓山镇樟林路14-15号')
        self.grid2.SetCellAlignment(0, 1, wx.ALIGN_CENTRE, wx.ALIGN_CENTRE)
        self.grid2.SetCellValue(0, 2, '15元')
        self.grid2.SetCellAlignment(0, 2, wx.ALIGN_CENTRE, wx.ALIGN_CENTRE)
        self.grid2.SetCellValue(0, 3, '快餐')
        self.grid2.SetCellAlignment(0, 3, wx.ALIGN_CENTRE, wx.ALIGN_CENTRE)

        self.grid2.SetCellValue(1, 0, '正宗兰州拉面')
        self.grid2.SetCellAlignment(1, 0, wx.ALIGN_CENTRE, wx.ALIGN_CENTRE)
        self.grid2.SetCellValue(1, 1, '樟林路72号')
        self.grid2.SetCellAlignment(1, 1, wx.ALIGN_CENTRE, wx.ALIGN_CENTRE)
        self.grid2.SetCellValue(1, 2, '26元')
        self.grid2.SetCellAlignment(1, 2, wx.ALIGN_CENTRE, wx.ALIGN_CENTRE)
        self.grid2.SetCellValue(1, 3, '清真菜')
        self.grid2.SetCellAlignment(1, 3, wx.ALIGN_CENTRE, wx.ALIGN_CENTRE)

        self.grid2.SetCellValue(1, 0, '金太郎韩式自助烤肉火锅(台江万达店)')
        self.grid2.SetCellAlignment(1, 0, wx.ALIGN_CENTRE, wx.ALIGN_CENTRE)
        self.grid2.SetCellValue(1, 1, '鳌江路台江万达广场金街2楼万达广场街2F-85号(3号门向阳坊楼上)')
        self.grid2.SetCellAlignment(1, 1, wx.ALIGN_CENTRE, wx.ALIGN_CENTRE)
        self.grid2.SetCellValue(1, 2, '56元')
        self.grid2.SetCellAlignment(1, 2, wx.ALIGN_CENTRE, wx.ALIGN_CENTRE)
        self.grid2.SetCellValue(1, 3, '外国餐厅')
        self.grid2.SetCellAlignment(1, 3, wx.ALIGN_CENTRE, wx.ALIGN_CENTRE)
        ...
        self.grid1.SetCellValue(0, 0, '安野牧场（西二环店）')
        self.grid1.SetCellAlignment(0, 0, wx.ALIGN_CENTRE, wx.ALIGN_CENTRE)
        self.grid1.SetCellValue(0, 1, '洪山园路67号实达大厦1-2层')
        self.grid1.SetCellAlignment(0, 1, wx.ALIGN_CENTRE, wx.ALIGN_CENTRE)
        self.grid1.SetCellValue(0, 2, '727元')
        self.grid1.SetCellAlignment(0, 2, wx.ALIGN_CENTRE, wx.ALIGN_CENTRE)
        self.grid1.SetCellValue(0, 3, '特色风味')
        self.grid1.SetCellAlignment(0, 3, wx.ALIGN_CENTRE, wx.ALIGN_CENTRE)

        self.grid1.SetCellValue(1, 0, '王品牛排(福州大洋晶典店)')
        self.grid1.SetCellAlignment(1, 0, wx.ALIGN_CENTRE, wx.ALIGN_CENTRE)
        self.grid1.SetCellValue(1, 1, '八一七北路268号福州大洋晶典3层')
        self.grid1.SetCellAlignment(1, 1, wx.ALIGN_CENTRE, wx.ALIGN_CENTRE)
        self.grid1.SetCellValue(1, 2, '399元')
        self.grid1.SetCellAlignment(1, 2, wx.ALIGN_CENTRE, wx.ALIGN_CENTRE)
        self.grid1.SetCellValue(1, 3, '牛扒店')
        self.grid1.SetCellAlignment(1, 3, wx.ALIGN_CENTRE, wx.ALIGN_CENTRE)

        self.grid1.SetCellValue(2, 0, '王庄阿咪大牌档(王庄店)')
        self.grid1.SetCellAlignment(2, 0, wx.ALIGN_CENTRE, wx.ALIGN_CENTRE)
        self.grid1.SetCellValue(2, 1, '王庄长福路185号')
        self.grid1.SetCellAlignment(2, 1, wx.ALIGN_CENTRE, wx.ALIGN_CENTRE)
        self.grid1.SetCellValue(2, 2, '125元')
        self.grid1.SetCellAlignment(2, 2, wx.ALIGN_CENTRE, wx.ALIGN_CENTRE)
        self.grid1.SetCellValue(2, 3, '海鲜')
        self.grid1.SetCellAlignment(2, 3, wx.ALIGN_CENTRE, wx.ALIGN_CENTRE)
